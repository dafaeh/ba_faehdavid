...
#
# Inputs (data/):
#   appalachia_9ref.tif           CWDmax from GEE (bands: cwd_max,
#                                 gap_filled_months), EPSG:5070, 30 m
#   elevation_appalachia.tif      FABDEM from GEE, EPSG:5070, 30 m
#
# Intermediates (data/):
#   twi_appalachia.tif                TWI computed by whitebox (cached)
#   h1_h2_appalachia_pixels.csv       Stratified subsample used for all models
#
# Outputs (fig/):
#   h1_elevation_regression_appalachia.pdf
#   h2a_twi_regression_appalachia.pdf
#   h2b_valley_ridge_boxplot_appalachia.pdf
#   h2c_twi_quantile_boxplot_appalachia.pdf
#
# References:
...
ggsave(
  filename = here("fig", "h1_elevation_regression_appalachia.pdf"),
  plot     = p_h1,
  width    = 16,
  height   = 12,
  units    = "cm"
...
ggsave(
  filename = here("fig", "h2a_twi_regression_appalachia.pdf"),
  plot     = p_h2a,
  width    = 16,
  height   = 12,
  units    = "cm"
...
ggsave(
  filename = here("fig", "h2b_valley_ridge_boxplot_appalachia.pdf"),
  plot     = p_h2b,
  width    = 12,
  height   = 12,
  units    = "cm"
...
ggsave(
  filename = here("fig", "h2c_twi_quantile_boxplot_appalachia.pdf"),
  plot     = p_h2c,
  width    = 14,
  height   = 12,
  units    = "cm"
