# 03_shading_artefact_appalachia.R
...
# bottoms show higher CWDmax than ridges) in the Appalachian focus region.
#
...
elevation <- terra::resample(
  terra::rast(here("data", "elevation_appalachia.tif")), cwd, method = "bilinear"
)

twi <- terra::resample(
  terra::rast(here("data", "twi_appalachia.tif")), cwd, method = "bilinear"
)
...
print(plot_northness_appalachia)
...
# Steep terrain is more frequent at higher elevations in the Appalachians.
